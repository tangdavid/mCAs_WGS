...
BGEN_DIR="/mnt/project/Bulk/Imputation/Imputation from genotype (TOPmed)"
NUM_PCS=20

regenie \
	--step 2 \
	--bgen "$BGEN_DIR/ukb21007_c${CHR}_b0_v1.bgen" \
    --sample "$BGEN_DIR/ukb21007_c${CHR}_b0_v1.sample" \
    --ref-first \
